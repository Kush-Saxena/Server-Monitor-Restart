...
public class AnalyzeServiceImplServiceUbuntu implements IAnalyzeService {
	...
	public void analyze() {
		...
		List<String> serviceList = SharedVariables.serviceList;
		...
		for (String serviceName : serviceList) {
			...
			ServiceBean fetchedBean = analyzerHelper.queryServiceLinux(serviceName);
